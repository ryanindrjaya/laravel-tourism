...
@section('content')
  ...
  <div id="carousel-home">
    <video style="width: 100vw; height: 100vh;" autoplay loop>
          ...
          <div class="tour_container">
            ...
            <div class="img_container">
              <a href="{{ route('tempat.show', $tempat->id) }}">
                <img src="{{ URL::to('/') }}/img/tempat/{{ $tempat->image }}"
                  style="width: 560px;min-height:270px;max-height: 270px;object-fit: cover;" width="800" height="533"
          ...
          <div class="tour_container">
            ...
            <div class="img_container">
              <a href="acara/{{ $tempat->id }}">
                <img src="{{ URL::to('/') }}/img/acara/{{ $tempat->image }}"
                  style="width: 560px;min-height:270px;max-height: 270px;object-fit: cover;" width="800"
