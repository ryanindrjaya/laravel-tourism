...
<body>
  ...
  <section class="home-section">
      ...
      <div class="sales-boxes" style="width:100%;">
        <div class="recent-sales box" style="width:100%;">
          ...
          <form action="{{ route('category.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="tDesc">Gambar Utama:</label> 
          ...
          <div class="title">Tambahkan Tempat</div>
            <div class="sales-details">
              <form action="{{ route('tempat.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary">Simpan</button>
                        <a href="/admin?type=temp"class="btn btn-danger">
                            Batal
                        </a>
                    </div>
                </form>
    ...
    <div class="home-content">
      <div class="sales-boxes" style="width:100%;">
        <div class="recent-sales box" style="width:100%;">
          <div class="title">Tambahkan Headline</div>
            <div class="sales-details">
    ...
    <div class="home-content">
      <div class="sales-boxes" style="width:100%;">
        <div class="recent-sales box" style="width:100%;">
          <div class="title">Tambahkan Acara</div>
            <div class="sales-details">
                <div class="table-responsive">
