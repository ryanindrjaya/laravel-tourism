...
@section('content')
  ...
  <section class="parallax-window" data-parallax="scroll" data-image-src="" data-natural-width="1400"
    data-natural-height="470">
    <div style="display: flex;justify-content: center;">
      <img src="{{ URL::to('/') }}/img/tempat/{{ $tempat->image }}" alt="img"
        style="object-fit: cover;z-index: -1;min-height: 450px;max-height: 455px;width:100%">
    </div>
        ...
        <div class="col-lg-12" id="single_tour_desc">
                ...
                @foreach ($imageArray as $img)
                  <div class="carousel-item {{ $loop->first ? 'active' : '' }} justify-content-center">
                    <div class="justify-content-center">
                      <img class="d-block w-100" style="height: 350px;object-fit:contain;"
                        src="{{ URL::to('/') }}/img/tempat/{{ $img->image }}" alt="{{ $img }}">
                    </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-10">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <h4>Website</h4>
                  <a href="http://{{ $tempat->url }}" target="_blank"
                    rel="noopener noreferrer">{{ $tempat->url }}</a>
                </div>
              </div>
              <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-lg-10" style="height: 300px;">
              ...
              <script>
                ...
                var oldMap = '<iframe src = "https://maps.google.com/maps?q=' + lat + ',' + long +
                  '&hl=id;z=14&amp;output=embed" style="height:272px;position:inherit;"></iframe>'
                var newMap =
                  '<iframe src = "https://www.google.com/maps/embed/v1/view?key=AIzaSyBF9WoovlYn7H9Ezuhpionl1qz3VWxwbMg&center=' +
                  lat + ',' + long + '&zoom=18" style="height:272px;position:inherit;"></iframe>'
              ...
              <!-- <div id="map-container" style="position:relative;">
                              ...
                              <script>
                                ...
                                'pk.eyJ1IjoiaWJudW5hdWZhbCIsImEiOiJjbDJiNnlkZmUwMWd4M2ludTY1bGV0ZXp1In0.Na4Q7E7Tyc6Uzwj6ZZiy8Q';
                                ...
                                new mapboxgl.Marker().setLngLat([long, lat])
                                  .setPopup(new mapboxgl.Popup().setHTML(
                                    "<h4>{{ $tempat->name }}<br>{{ $tempat->address }} <br></h4> <h5><a href=" + url +
                                    " target='_blank'>Buka di maps</a></h5>")) // add popup
                                  .addTo(map)
                              </script>
                          </div> -->
            </div>
          ...
          <div class="row">
            <div class="col-lg-3">
              <h3>Reviews</h3>
              @if (count($reviews) > 0)
                <a href="#" class="btn_1 add_bottom_30" data-toggle="modal" data-target="#myReview">Tambahkan
                  review</a>
              @endif
            </div>
            <div class="col-lg-9">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-10">
                          ...
                          <p>
                            ...
                            consequat ut sed sem. Duis quis tempor nunc. Interdum et malesuada fames ac ante ipsum primis
                            in faucibus."
                          </p>
                        </div>
                      </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                <input name="name_review" id="name_review" type="text" placeholder="Nama" class="form-control"
                  {{ Auth::check() ? '' : 'disabled="disabled"' }}>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <input name="email_review" id="email_review" type="email" placeholder="Email"
                  class="form-control" {{ Auth::check() ? '' : 'disabled="disabled"' }}>
              </div>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <input id="vote" name="vote" type="range" value="0" step="1" min="1"
            ...
            <div class="col-md-2">
              <input name="id_tempat" id="id_tempat" type="hidden" placeholder="id" class="form-control"
                value="{{ $tempat->id }}" style="visibility: hidden;">
            </div>
          </div>
          <!-- End row -->
          <div class="form-group">
            <textarea name="review_text" id="review_text" class="form-control" style="height:100px"
              placeholder="Write your review" {{ Auth::check() ? '' : 'disabled="disabled"' }}></textarea>
          </div>
          <hr>
          <!-- <div class="form-group">
       <input type="text" id="verify_review" class=" form-control" placeholder="Verifikasi diri anda. 3 + 1 =">
      </div> -->
          <input {{ Auth::check() ? 'type="submit"' : 'type="disabled"' }}
            style="{{ Auth::check() ? '' : 'background: grey;' }}" value="Submit" class="btn_1" id="submit-review"
            disabled="disabled">
          @if (Auth::guest())
            <br>
            <br>
