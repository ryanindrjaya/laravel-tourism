@extends('layouts.app')
@section('title')
<title>Akomodasi | Web Salatiga</title>
@endsection
@section('content')
						...
						<div class="row">
							<div class="col-lg-4 col-md-4">
								...
								<div class="img_list">
									...
									<?php
										...
										?>
										<img src="{{ URL::to('/') }}/img/akomodasi/{{ $tempArr[0] }}" style="max-width: 353px;max-height: 350px;object-fit: cover;left: 0px;right: 0px;" alt="Image">
										<div class="short_info"><i class="icon_set_1_icon-23"></i> {{$akomodasi->tags}} </div>
									</a>
								</div>
							</div>
									...
									<ul class="add_info">
										<li>
											<div class="tooltip_styled tooltip-effect-4">
												...
												<div class="tooltip-content">
													<h4>Jadwal</h4>
													<strong>Senin-Jumat</strong> {{$akomodasi->seninJumat}}
													<br>
													<strong>Sabtu-Minggu</strong> {{$akomodasi->sabtuMinggu}}
										...
										<li>
											<div class="tooltip_styled tooltip-effect-4">
												...
												<div class="tooltip-content">
													<h4>Alamat</h4> {{ $akomodasi->address }}
													<br>
												</div>
											</div>
										</li>
										<li>
											<div class="tooltip_styled tooltip-effect-4">
												...
												<div class="tooltip-content">
													<h4>Parkir</h4> 
													{{ $akomodasi->parkiran ? "Tersedia": "Tidak Tersedia" }}
												</div>
											</div>
										</li>
										<li>
											<div class="tooltip_styled tooltip-effect-4">
												...
												<div class="tooltip-content">
													<h4>Akses</h4>
													{{ $akomodasi->disabilitas ? "Ramah Disabilitas": "Tidak Ramah Disabilitas" }}
													<br>
												</div>
											</div>
										</li>
							...
							<div class="col-lg-2 col-md-2">
								<div class="price_list">
									<div>
										<p><a href="{{ route('akomodasi.show',$akomodasi->id) }}" class="btn_1">Details</a>
										</p>
									</div>
