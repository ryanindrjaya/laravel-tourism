...
@extends('layouts.app')
@section('title')
<title>Admin Page | Edit Akomodasi</title>
@endsection
@section('content')
    ...
    <div class="container margin_60">
        <div class="row">
            <div class="col-lg-12">
                ...
                @endif
                <form action="{{ route('akomodasi.update', $akomodasi->id) }}" method="POST" enctype="multipart/form-data">
                @method('PATCH')    
                @csrf
                    <div class="form-group">
                        <label for="tName">Nama:</label>
                        <input type="text" class="form-control" id="tName" placeholder="Masukkan Nama" name="tName" value="{{$akomodasi->name}}">
                    </div>
                    <div class="form-group">
                        <label for="tDesc">Deskripsi:</label>
                        <textarea class="form-control" id="tDesc" name="tDesc" rows="3" placeholder="Masukkan Deskripsi" value="{{$akomodasi->desc}}">{{$akomodasi->desc}}</textarea>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-lg-6">
                                <label for="tLong">Kecamatan:</label>
                                <select name="kecamatan" id="kecamatan" value="{{$akomodasi->kecamatan}}" class="form-control select2">
                                    <option value =""> PILIH KECAMATAN</option>
                                    <option value ="ARGOMULYO" {{ $akomodasi->kecamatan == 'ARGOMULYO' ? 'selected' : '' }}> ARGOMULYO</option>
                                    <option value ="TINGKIR" {{ $akomodasi->kecamatan == 'TINGKIR' ? 'selected' : '' }}> TINGKIR</option>
                                    <option value ="SIDOMUKTI" {{ $akomodasi->kecamatan == 'SIDOMUKTI' ? 'selected' : '' }}> SIDOMUKTI</option>
                                    <option value ="SIDOREJO" {{ $akomodasi->kecamatan == 'SIDOREJO' ? 'selected' : '' }}> SIDOREJO</option>
                                </select>
                            </div>
                            <div class="col-lg-6">
                                <label for="tLat">Desa:</label>
                                <select name="desa" id="desa" class="form-control select2">
                                    <option value="{{$akomodasi->desa}}">{{$akomodasi->desa}}</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="tMaps" placeholder="Masukkan Url" name="tMaps" value="{{$akomodasi->mapUrl}}">
                    </div>
                    <div class="form-group">
                        <label for="image">Foto: </label> <br>
                        <?php
                        $temp = str_replace("[","",$akomodasi->imageArray);
                        ...
                        <table>
                            <tr>
                                ...
                                <td id="t{{$i}}">
                                    ...
                                    <img src="{{URL::to('/')}}/img/akomodasi/{{$t}}" style="max-width:100px; max-height:100px" alt="">
                                </td> 
                                @php
                                ++$i;
                                @endphp
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="tTicket" placeholder="Masukkan Harga Ticket" name="tTicket" value="{{$akomodasi->ticket}}">
                    </div>
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <label for="tLat">Senin-Jumat:</label>
                                <div class="row">
                                    <div class="col-lg-5">
                                        <input type="time" id="seninJumat1" name="seninJumat1" placeholder="Buka" class="form-control" value="{{substr($akomodasi->seninJumat, 0, 5)}}">
                                    </div>
                                    <div class="col-lg-2">
                                        <label for="">Sampai</label>
                                    </div>
                                    <div class="col-lg-5">
                                        <input type="time" id="seninJumat2" name="seninJumat2" placeholder="Buka" class="form-control" value="{{substr($akomodasi->seninJumat, 6,10)}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                ...
                                <div class="row">
                                    <div class="col-lg-5">
                                        <input type="time" id="sabtuMinggu1" name="sabtuMinggu1" placeholder="Buka" class="form-control" value="{{substr($akomodasi->sabtuMinggu, 0,5)}}">
                                    </div>
                                    <div class="col-lg-2">
                                        <label for="">Sampai</label>
                                    </div>
                                    <div class="col-lg-5">
                                        <input type="time" id="sabtuMinggu2" name="sabtuMinggu2" placeholder="Buka" class="form-control" value="{{substr($akomodasi->sabtuMinggu, 6,10)}}">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="tTiket" placeholder="Masukkan Harga Tiket" name="tTiket" value="{{$akomodasi->ticket}}"> -->
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control js-example-basic-multiple" name="tags[]" multiple="multiple">
                            ...
                            <option value="HOTEL" {{ Str::contains($akomodasi->tags, 'HOTEL') ? 'selected':'' }}>HOTEL</option>
                            <option value="WISMA" {{ Str::contains($akomodasi->tags, 'WISMA') ? 'selected':'' }}>WISMA</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="cIsAllDay" name="cIsAllDay" value="1" {{ $akomodasi->isOpenAllDay == '1' ? 'checked' :'' }} >
                            <label class="form-check-label" for="cIsAllDay">Buka 24 Jam</label>
                        </div>
                        <div class="form-group form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="cDisabilitas" name="cDisabilitas" value="1" {{ $akomodasi->disabilitas == '1' ? 'checked' :'' }} >
                            <label class="form-check-label" for="cDisabilitas">Ramah Bagi disabilitas</label>
                        </div>
                        <div class="form-group form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="cParkir" name="cParkir" value="1" {{ $akomodasi->parkiran == '1' ? 'checked' :'' }} >
                            <label class="form-check-label" for="cParkir">Tersedia Parkir</label>
                        </div>
                        <div class="form-group form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="cWifi" name="cWifi" value="1" {{ $akomodasi->wifi == '1' ? 'checked' :'' }} >
                            <label class="form-check-label" for="cWifi">Tersedia Wifi</label>
                        </div>
                        <div class="form-group form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="cHeadline" name="cHeadline" value="1" {{ $akomodasi->isHeadline == '1' ? 'checked' :'' }} >
                            <label class="form-check-label" for="cHeadline">Tampilkan pada halaman Utama</label>
                        </div>
                        <div class="form-group form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="cIcon" name="cIcon" value="1" {{ $akomodasi->isIcon == '1' ? 'checked' :'' }} >
