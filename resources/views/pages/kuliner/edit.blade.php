...
@extends('layouts.app')
@section('title')
<title>Admin Page | Edit Kuliner</title>
@endsection
@section('content')
            ...
            <div class="col-lg-12">
                ...
                @csrf
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <select name="kecamatan" id="kecamatan" value="{{$kuliner->kecamatan}}" class="form-control select2">
                                    <option value =""> PILIH KECAMATAN</option>
                                    <option value ="ARGOMULYO" {{ $kuliner->kecamatan == 'ARGOMULYO' ? 'selected' : '' }}> ARGOMULYO</option>
                                    <option value ="TINGKIR" {{ $kuliner->kecamatan == 'TINGKIR' ? 'selected' : '' }}> TINGKIR</option>
                                    <option value ="SIDOMUKTI" {{ $kuliner->kecamatan == 'SIDOMUKTI' ? 'selected' : '' }}> SIDOMUKTI</option>
                                    <option value ="SIDOREJO" {{ $kuliner->kecamatan == 'SIDOREJO' ? 'selected' : '' }}> SIDOREJO</option>
                                </select>
                            </div>
                            <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="tMaps" placeholder="Masukkan Url" name="tMaps" value="{{$kuliner->mapUrl}}">
                    </div>
                    <div class="form-group">
                        ...
                        <table>
                            <tr>
                                ...
                                <td id="t{{$i}}">
                                    ...
                                    <img src="{{URL::to('/')}}/img/kuliner/{{$t}}" style="max-width:100px; max-height:100px" alt="">
                                </td> 
                                @php
                                ++$i;
                                @endphp
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="tTicket" placeholder="Masukkan Harga Ticket" name="tTicket" value="{{$kuliner->ticket}}">
                    </div>
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <label for="tLat">Senin-Jumat:</label>
                                <div class="row">
                                    <div class="col-lg-5">
                                        <input type="time" id="seninJumat1" name="seninJumat1" placeholder="Buka" class="form-control" value="{{substr($kuliner->seninJumat, 0, 5)}}">
                                    </div>
                                    <div class="col-lg-2">
                                        <label for="">Sampai</label>
                                    </div>
                                    <div class="col-lg-5">
                                        <input type="time" id="seninJumat2" name="seninJumat2" placeholder="Buka" class="form-control" value="{{substr($kuliner->seninJumat, 6,10)}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                ...
                                <div class="row">
                                    <div class="col-lg-5">
                                        <input type="time" id="sabtuMinggu1" name="sabtuMinggu1" placeholder="Buka" class="form-control" value="{{substr($kuliner->sabtuMinggu, 0,5)}}">
                                    </div>
                                    <div class="col-lg-2">
                                        <label for="">Sampai</label>
                                    </div>
                                    <div class="col-lg-5">
                                        <input type="time" id="sabtuMinggu2" name="sabtuMinggu2" placeholder="Buka" class="form-control" value="{{substr($kuliner->sabtuMinggu, 6,10)}}">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="tTiket" placeholder="Masukkan Harga Tiket" name="tTiket" value="{{$kuliner->ticket}}">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control js-example-basic-multiple" name="tags[]" multiple="multiple">
                            ...
                            <option value="TRADISIONAL" {{ Str::contains($kuliner->tags, 'TRADISIONAL') ? 'selected':'' }}>TRADISIONAL</option>
                            <option value="RESTAURANT" {{ Str::contains($kuliner->tags, 'RESTAURANT') ? 'selected':'' }}>RESTAURANT</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="cIsAllDay" name="cIsAllDay" value="1" {{ $kuliner->isOpenAllDay == '1' ? 'checked' :'' }} >
                            <label class="form-check-label" for="cIsAllDay">Buka 24 Jam</label>
                        </div>
                        <div class="form-group form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="cDisabilitas" name="cDisabilitas" value="1" {{ $kuliner->disabilitas == '1' ? 'checked' :'' }} >
                            <label class="form-check-label" for="cDisabilitas">Ramah Bagi disabilitas</label>
                        </div>
                        <div class="form-group form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="cParkir" name="cParkir" value="1" {{ $kuliner->parkiran == '1' ? 'checked' :'' }} >
                            <label class="form-check-label" for="cParkir">Tersedia Parkir</label>
                        </div>
                        <div class="form-group form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="cWifi" name="cWifi" value="1" {{ $kuliner->wifi == '1' ? 'checked' :'' }} >
                            <label class="form-check-label" for="cWifi">Tersedia Wifi</label>
                        </div>
                        <div class="form-group form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="cHeadline" name="cHeadline" value="1" {{ $kuliner->isHeadline == '1' ? 'checked' :'' }} >
                            <label class="form-check-label" for="cHeadline">Tampilkan pada halaman Utama</label>
                        </div>
                        <div class="form-group form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="cIcon" name="cIcon" value="1" {{ $kuliner->isIcon == '1' ? 'checked' :'' }} >
