...
@extends('layouts.app')
@section('title')
<title>{{$kuliner->name}} | Detail</title>
@endsection
@section('content')
        ...
        <div class="row">
            <div class="col-lg-12" id="single_tour_desc">
                    ...
                    @foreach(explode(',',$temp) as $img)
                        <div class="carousel-item {{ $loop->first ? 'active' : '' }} justify-content-center">
                            <div class="justify-content-center">
                                <img class="d-block img-fluid align-middle" src="{{URL::to('/')}}/img/kuliner/{{ $img }}" alt="{{ $img }}">
                            </div>
                        </div>
                    @endforeach
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10">
                        ...
                        <div class="row">
                            ...
                            <h4>Operasional</h4>
                                <ul>
                                    <li>Senin-Jumat : {{$kuliner->seninJumat}}</li>
                                    <li>Sabtu-Minggu : {{$kuliner->sabtuMinggu}}</li>
                                </ul>
                            </div>
                            <div class="col-md-6">
                                <!-- <h4>Harga Tiket</h4>
                                <ul>
                                    <li>Tiket : {{$kuliner->ticket}}</li>
                                </ul> -->
                            </div>
                        </div>
                        <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10">
                        <h5>Kelurahan {{ $kuliner->desa }}, Kecamatan {{ $kuliner->kecamatan }}</h5>
                        ...
                        <div id="map-container" style="position:relative;">
                            ...
                            <script>
                                console.log("asd");
                                var url = {!! json_encode($kuliner->mapUrl) !!};
                                ...
                                .setPopup(new mapboxgl.Popup().setHTML(
                                    "<h4>{{$kuliner->name}}<br>{{$kuliner->address}} <br></h4> <h5><a href="+url+" target='_blank'>Buka di maps</a></h5>")) // add popup
                                .addTo(map)
                            </script>
                        </div>
                    </div>
