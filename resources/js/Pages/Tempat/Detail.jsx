...
const Fasilitas = ({ icon, text }) => {
    return (
        <div className="flex flex-col items-center justify-center">
            <img
                className="p-2 h-14 lg:h-24 rounded-full bg-white shadow-sm"
                src={`/vector/tempat/${icon}`}
                alt=""
            />
            <h1 className="font-heading text-md text-center lg:text-xl mt-2">
                {text}
            </h1>
        </div>
    );
...
export default function Detail({ tempat, imageArray, ratings, reviews }) {
    ...
    return (
        <>
            <Head>
                <title>Detail Tempat | Disbudpar Salatiga</title>
            </Head>
            <MainLayout>
